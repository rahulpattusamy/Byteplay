const AboutUs = () => {
  return (
    <section
      id="about"
      className="max-w-4xl mx-auto py-16 px-6 text-gray-300"
    >
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-white text-center">
        Why Byte Play?
      </h2>
      <ul className="list-disc list-inside text-gray-400 md:ml-20 lg:ml-40">
